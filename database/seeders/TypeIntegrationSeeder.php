...
class TypeIntegrationSeeder extends Seeder
{
    public function run(): void
    {
        $types = [
            ...
            ['nom' => 'Concours',               'description' => 'Intégration par voie de concours ouvert'],
            ...
            ['nom' => 'Recommandation',         'description' => 'Intégration sur recommandation d\'une autorité'],

            // Cadre légal FP Congo
        ...
        foreach ($types as $data) {
            TypeIntegration::firstOrCreate(['nom' => $data['nom']], $data);
        }
    }
}
