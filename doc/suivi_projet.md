...
**État :** cœur « vie de l’agent » API **livré**. **D.2 Discipline, D.3 P1 + D.3.4 Prestations, D.4 Formation, D.5 Paie, D.6 Reporting livrés.** Vague E lots **A–E** livrés. Prochain : **D.3.5 Santé / AT-MP**. Modules DRHL suivants **globaux** (pas de cloison bureau).
...
**Vague E** — lots **A–E** livrés. **D.5 Paie**, **D.6 Reporting** et **D.3.4 Prestations livrés**. Suite : **D.3.5 Santé / AT-MP**. Plan [`plan-module-prestations.md`](./plan-module-prestations.md).
