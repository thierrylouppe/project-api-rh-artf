...
> Références : [`plan-prochaines-fonctionnalites.md`](./plan-prochaines-fonctionnalites.md) · [`plan_complet.md`](./plan_complet.md) · [`plan-module-paie.md`](./plan-module-paie.md) · [`plan-module-reporting.md`](./plan-module-reporting.md) · [`note-fe-etat-implementations.md`](./note-fe-etat-implementations.md) · [`roadmap.md`](./roadmap.md) · [`structuration_par_module.md`](./structuration_par_module.md) · [`SPEC-GRILLE-SALARIALE.md`](./SPEC-GRILLE-SALARIALE.md)
...
**État :** cœur « vie de l’agent » API **livré**. **D.2 Discipline, D.3 P1 Affaires sociales, D.4 Formation, D.5 Paie, D.6 Reporting livrés.** Vague E lots **A–E** livrés. Prochain : **D.3.4 Prestations**. Modules DRHL suivants **globaux** (pas de cloison bureau).
...
**Vague E** — lots **A–E** livrés. **D.5 Paie** et **D.6 Reporting livrés**. Suite : **D.3.4 Prestations**. Plan [`plan-module-reporting.md`](./plan-module-reporting.md).
