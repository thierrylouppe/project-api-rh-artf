...
**Statut actuel :** cœur « vie de l’agent » API livré, **discipline (D.2) livrée**. Prochain : affaires sociales (D.3), puis formation, paie, reporting — **modules globaux, pas de cloisonnement par bureau**. Voir [`plan-prochaines-fonctionnalites.md`](./plan-prochaines-fonctionnalites.md).
