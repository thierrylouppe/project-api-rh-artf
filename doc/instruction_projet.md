...
**Statut actuel :** cœur « vie de l’agent » API livré, **discipline (D.2)**, **affaires sociales P1 + prestations D.3.4**, **formation (D.4)**, **paie (D.5)** et **reporting (D.6)** livrés. Prochain : santé D.3.5 — **modules globaux, pas de cloisonnement par bureau**. Voir [`plan-prochaines-fonctionnalites.md`](./plan-prochaines-fonctionnalites.md).
...
| Affaires sociales | ✅ P1 + D.3.4 | Vague D.3.1–D.3.4 (`/affaires-sociales`) ; santé D.3.5 plus tard |
