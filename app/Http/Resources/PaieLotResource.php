...
class PaieLotResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'actions' => [
                'generer' => $this->statut?->peutGenerer() ?? false,
                'controler' => $this->statut?->peutControler() ?? false,
                'valider' => $this->statut?->peutValider() ?? false,
                'cloturer' => $this->statut?->peutCloturer() ?? false,
                'supprimer' => $this->statut?->peutSupprimer() ?? false,
                'exporter' => $this->statut?->peutExporter() ?? false,
                'modifier' => $this->statut?->peutModifier() ?? false,
            ],
            'anomalies' => $anomalies,
