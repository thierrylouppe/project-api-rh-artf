...
class AgentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'informations_personnelles'     => new InformationsPersonnelleResource($this->whenLoaded('informationsPersonnelles')),
            'informations_professionnelles' => new InformationsProfessionnelleResource($this->whenLoaded('informationsProfessionnelles')),
            'contacts_urgence'              => ContactUrgenceResource::collection($this->whenLoaded('contactsUrgence')),
            'situation_familiale'           => new SituationFamilialeResource($this->whenLoaded('situationFamiliale')),
            'documents'                     => DocumentAgentResource::collection($this->whenLoaded('documents')),
