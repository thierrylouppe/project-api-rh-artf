...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'motif_archivage', type: 'string', nullable: true),
        new OA\Property(property: 'motif_archivage_code', type: 'string', nullable: true),
        new OA\Property(property: 'prioritaire_reembauche_jusquau', type: 'string', format: 'date', nullable: true),
