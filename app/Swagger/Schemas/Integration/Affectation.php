...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'motif_code', type: 'string', nullable: true, example: 'rapprochement_conjoints'),
        new OA\Property(property: 'commentaire_opportunite', type: 'string', nullable: true),
        new OA\Property(property: 'pieces_rapprochement', type: 'object', nullable: true),
